...
{
    public class PermissionDeleteCommandRequest : RequestBase<PermissionDeleteCommandRequest>, IRequest<PermissionDeleteCommandResponse>
    {
        public PermissionDeleteCommandRequest(Guid id)
        {
            Id = id;
            ValidateModel();
        }
