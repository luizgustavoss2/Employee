...
{
    public class UserGetByIdCommandRequest : RequestBase<UserGetByIdCommandRequest>, IRequest<UserGetByIdCommandResponse>
    {
        public UserGetByIdCommandRequest(Guid id)
        {
            Id = id;
            ValidateModel();
        }
